...
MarketingControl.prototype.handle = function (headNode, bodyStr, userCb) {
    var self = this;
    async.waterfall([
        //是否是支持的cmd
        function (cb) {
 ...
 * @param bodyNode
 * @param cb
 * @Description  MC01 推荐人信息
 */

MarketingControl.prototype.checkMC01 = function (headNode, bodyNode, cb) {
    cb(null);
};

MarketingControl.prototype.handleMC01 = function (headNode, bodyNode, cb) {
