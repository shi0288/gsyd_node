...
var LoanControl = function () {
    var self = this;
    self.cmd = {'LC01': 1, 'LC02': 2};
    self.cmdArray = [{},
        {id: 1, code: 'LC01', fromType: prop.digestFromType.DB, des: "创建借款"},
        {id: 2, code: 'LC02', fromType: prop.digestFromType.DB, des: "审核标的"}
    ];
};
