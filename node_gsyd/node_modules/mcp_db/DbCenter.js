...
DbCenter.prototype._initMain = function (cb) {
    ...
    var user = new Table(db, "user", [
        ...
        new Column(db, "status", "char", 1, false, undefined),
        new Column(db, "realname", "varchar", 100, false, undefined),
        new Column(db, "sex", "varchar", 2, false, undefined),
        new Column(db, "birthday", "date", -1, false, undefined),
        new Column(db, "home_address", "varchar", 100, false, undefined),
        new Column(db, "QQ", "varchar", 12, false, undefined),
        new Column(db, "MSN", "varchar", 100, false, undefined),
        new Column(db, "mobile_number", "varchar", 18, false, undefined),
        new Column(db, "id_card", "varchar", 20, false, undefined),
        new Column(db, "current_address", "varchar", 100, false, undefined),
        new Column(db, "nickname", "varchar", 50, false, undefined),
        new Column(db, "security_question1", "varchar", 100, false, undefined),
        new Column(db, "security_question2", "varchar", 100, false, undefined),
        new Column(db, "security_answer1", "varchar", 100, false, undefined),
        new Column(db, "security_answer2", "varchar", 100, false, undefined),
        new Column(db, "last_login_time", "date", -1, false, undefined),
        new Column(db, "register_time", "date", -1, false, undefined),
        new Column(db, "area", "varchar", 32, false, undefined),
        new Column(db, "comment", "text", -1, false, undefined),
        new Column(db, "cash_password", "varchar", 50, false, undefined),
        new Column(db, "area_city", "varchar", 32, false, undefined),
        new Column(db, "photo", "varchar", 500, false, undefined),
        new Column(db, "score", "int", 20, false, undefined),
        new Column(db, "disable_time", "date", -1, false, undefined),
        new Column(db, "borrower_info_id", "varchar", 32, false, undefined),
        new Column(db, "level", "varchar", 32, false, undefined),
        new Column(db, "bind_ip", "varchar", 1000, false, undefined),
        new Column(db, "referrer", "varchar", 1000, false, undefined),
        new Column(db, "gas_card", "varchar", 255, false, undefined),
        new Column(db, "gas_station", "varchar", 255, false, undefined),
        new Column(db, "gas_time", "date", -1, false, undefined),
        new Column(db, "plate_number", "varchar", 255, false, undefined),
        new Column(db, "last_login_area", "varchar", 32, false, undefined),
        new Column(db, "subst_id", "varchar", 255, false, undefined),
        new Column(db, "ukey_salt_value", "varchar", 1000, false, undefined),
        new Column(db, "ukey_serial_number", "varchar", 1000, false, undefined),
        new Column(db, "ukey_password", "varchar", 1000, false, undefined)
    ]);
    db.put(user);
    ...
    var role = new Table(db, "role", [
        new Column(db, "id", "varchar", 32, false, undefined, true, false),
        new Column(db, "name", "varchar", 100, false, undefined),
        new Column(db, "description", "text", -1, false, undefined)
    ]);
    db.put(role);
