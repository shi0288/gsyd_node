 ...
 * @param cb
 */
AyfxEngine.prototype.start = function (loanObj, repayTypeObj, cb) {
    var self = this;
 ...
 * @param cb
 */
AyfxEngine.prototype.pt = function (loanObj, repayTypeObj, jt, cb) {
 ...
 * @param cb
 */
AyfxEngine.prototype.ptx = function (loanObj, repayTypeObj, jt, cb) {
    var investTab = dc.main.get('invest');
    var cursor = investTab.find({loan_id: loanObj.id,status:investCons.bid_success}, {}, []).sort({create_time: 1});
    cursor.dateToString();
    cursor.count(function (err, count) {
                    ...
                    async.eachSeries(data, function (investObj, callback) {
                        ...
                        async.eachSeries(loanRepayObjArr, function (obj, repayCall) {
                            ...
                            if (order == count) {
                                ...
                                interest = sumInterest - hadRepayObjArr[_index].hadInterest;
                            } else {
...
var ayfxEngine = new AyfxEngine();
module.exports = ayfxEngine;